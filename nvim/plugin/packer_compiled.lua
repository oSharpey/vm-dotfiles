...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/oscar/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/oscar/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["lualine-copilot"] = {
    loaded = true,
    path = "/home/oscar/.local/share/nvim/site/pack/packer/start/lualine-copilot",
  ...
  ["onenord.nvim"] = {
    loaded = true,
    path = "/home/oscar/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  ["zig.vim"] = {
    loaded = true,
    path = "/home/oscar/.local/share/nvim/site/pack/packer/start/zig.vim",
